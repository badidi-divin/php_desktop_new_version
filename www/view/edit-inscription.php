<?php
	...
	require_once '../model/edit-inscription.php';
			...
			<form method="post" action="" enctype="multipart/form-data">
				<div class="form-group">
					...
					<select name="code_apprenant" class="form-control">
							<?php
								$ps=$pdo->prepare("SELECT * FROM apprenant");
								$ps->execute();
								?>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
					...
					<input type="text" name="session" required="required" class="form-control" placeholder="Session" value="<?= $userinfo['session'] ?>">
			  </div>
