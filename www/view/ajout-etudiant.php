<?php
	...
	require_once '../model/ajout-etudiant.php';
...
<div class="contenair space col-md-6 col-xd-12 col-md-offset-3">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="a">ENREGISTREMENT ELEVES</h3>
		</div>
		<div class="panel-body">
			<form method="post" action="" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" name="matricule" required="required" class="form-control" value="<?php echo $matr; ?>" readonly="readonly">
				</div>
			  <div class="form-group">
					<label class="control-label">
						NOM COMPLET:
					</label>
					<input type="text" name="nom_complet" required="required" class="form-control">
			  </div>
			   <div class="form-group">
					<label class="control-label">
						SEXE:
