...
<!-- navigation end -->
	<?php 
		...
		require_once('../model/selection_inscription.php');
	?>
		...
		<div class="panel panel-primary ">
			...
			<form method="get" action="" class="form-inline">
						...
						Rechercher</button>
						&nbsp;&nbsp;
						<a href="ajout-inscription.php" class="btn btn-primary">Ajouter</a>
						&nbsp;&nbsp;
						<a href="imprimer-inscription.php" class="btn btn-danger">Imprimer</a>
						&nbsp;&nbsp;
					...
					<div class="panel-body">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<td><?php  
								if ($et['montant_a_payer']==0) {
									?>
									<a href="#" class="btn btn-success">Aucune dette</a>
								<?php }else{
									echo($et['montant_a_payer']."$"); 	
								}?>
								</td>
								<td><?php  echo($et['session'])?></td>
								<td><?php  echo($et['date_inscription'])?></td>
								<!--liens -->
								<td><a onclick="return confirm('Etes-vous sûre...?');" href="../model/supprimer-inscription.php?id=<?php echo($et['id'])?>" class="btn btn-danger">Supprimer</a></td>
								<td><a href="edit-inscription.php?id=<?php echo($et['id'])?>" class="btn btn-primary">Editer</a></td>
								<td></td>
											</tr>	
									<?php } ?>	
							</tbody>
